...
class NoxEventReport(models.TransientModel):
    ...
    def action_generate_report(self):
        ...
        for rec in self:
            ...
            attendees = self.env['event.registration'].search_read([('event_id', '=', rec.event_id.id)],
            ...
            for attendee in attendees:
                ...
                for question_id in question_ids_list:
                    attendee_answer = self.env['event.registration.question.answer'].search_read(
                        [('event_registration_id', '=', attendee['id']),
